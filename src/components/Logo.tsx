export function Logo({ compact = false }: { compact?: boolean }) {
  return <div className="flex items-center gap-3" role="img" aria-label="Arena Hero">
    ...
    {!compact && <span className="logo-wordmark font-display text-sm font-bold tracking-[.18em] text-zinc-100">ARENA HERO</span>}
  </div>
}
