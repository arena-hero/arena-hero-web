  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'On the web, choose any explored destination. The solid segment is this Tick’s step; dashed segments are the route that will be recalculated after every state.',
      ],
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        '网页版可以选择任意已探索目的地；实线是本 Tick 要走的一步，虚线是后续路线，每次收到 state 都会重新寻路。',
      ],
