...
export const demoState: PlayerState = {
  ...
  objects: [
    ...
    { kind: 'CORE', id: id('1'), controlled: true, position: [0,0], hp: 5, shield: 8, state: 'NORMAL' },
    ...
    { kind: 'CORE', id: id('91'), controlled: false, position: [6,3], hp: 4, shield: 4, state: 'MOVING', move_direction: 'LEFT', move_progress: 2, move_required_ticks: 4, destination: [5,3] },
