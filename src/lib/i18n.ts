...
const resources = {
  en: { translation: {
    ...
    game: {
      ...
      resourceActivity: 'Resource activity', cargoDropped: 'Worker dropped {{count}} resource', cargoDropped_other: 'Worker dropped {{count}} resources', cargoRecovered: 'Recovered {{count}} dropped resource', cargoRecovered_other: 'Recovered {{count}} dropped resources', resourceOverflowDestroyed: 'Destroyed {{count}} excess Core resource', resourceOverflowDestroyed_other: 'Destroyed {{count}} excess Core resources', coreResourcesCaptured: 'Captured {{amount}} of {{available}} Core resources. {{destroyed}} did not fit and was destroyed (capacity {{capacity}}).', depositCoreMoving: 'Deposit failed: the Core started moving this Tick.', depositCoreNotPresent: 'Deposit failed: the Worker is no longer with your Core.', depositWorkerEmpty: 'Deposit failed: the Worker is carrying no resources.', moreResourceEvents: '{{count}} more resource event', moreResourceEvents_other: '{{count}} more resource events',
      ...
      respawningBy: 'Your Core was destroyed by {{destroyer}}.', respawningUnknown: 'Your Core was destroyed.', respawnWaiting: 'No legal spawn point is available yet. Retrying next Tick…', respawnHint: 'There is no respawn cooldown. A new Core and Worker deploy immediately when a valid point is available.',
      ...
      confirmSelfDestruct: 'Self-destruct this unit? It will be removed before upkeep. Worker cargo drops on this cell; there is no production refund.',
      emptyPlan: 'No manual overrides. Agent orders remain active.', connected: 'Live', disconnected: 'Disconnected',
      actions: { MOVE: 'Move', HARVEST: 'Harvest', DEPOSIT: 'Deposit', SWEEP: 'Sweep', SHOOT: 'Shoot', PICKUP_BEACON: 'Pick up Beacon', DROP_BEACON: 'Drop Beacon', SELF_DESTRUCT: 'Self-destruct', WAIT: 'Wait', SPAWN: 'Spawn', REPAIR_SHIELD: 'Repair shield', START_MOVE: 'Move Core', CANCEL_MOVE: 'Cancel migration' },
    ...
    tutorial: {
      ...
      steps: {
        ...
        9: { title: 'Sweep an adjacent enemy.', body: 'Vanguards attack one neighboring cell and damage every hostile unit there.', hint: 'Select the Vanguard, choose Sweep, then select the highlighted enemy.', wrong: 'Select the Vanguard that just launched.' },
        10: { title: 'Shoot from range.', body: 'Rangers fire horizontally, vertically, or diagonally in a straight line, up to three cells away.', hint: 'Select the Ranger, choose Shoot, then select the highlighted enemy.', wrong: 'Select the highlighted Ranger.' },
  ...
  zh: { translation: {
    ...
    game: {
      ...
      respawningBy: '你的 Core 被 {{destroyer}} 摧毁了。', respawningUnknown: '你的 Core 被摧毁了。', respawnWaiting: '暂时找不到合法出生点，将在下一 Tick 重试……', respawnHint: '复活没有冷却；只要存在合法出生点，新的 Core 和 Worker 会立即部署。',
      produceUnit: '生产单位', resourcesAvailable: '当前资源 {{count}}', unitCost: '{{cost}} 资源', coreResourceFull: '资源已达上限。容量至少为 10，之后按人口 × 5 计算（当前 {{capacity}}）。',
      confirmSelfDestruct: '确定自毁这个单位吗？它会在扣维护费前消失；Worker 携带的资源会掉在当前格，但不会返还生产费用。',
      emptyPlan: '没有手动覆盖，Agent 指令继续生效。', connected: '实时', disconnected: '已断开',
      actions: { MOVE: '移动', HARVEST: '采集', DEPOSIT: '交付', SWEEP: '横扫', SHOOT: '射击', PICKUP_BEACON: '拾取信标', DROP_BEACON: '放下信标', SELF_DESTRUCT: '自毁', WAIT: '原地待命', SPAWN: '生产', REPAIR_SHIELD: '修复护盾', START_MOVE: '迁移 Core', CANCEL_MOVE: '取消迁移' },
    ...
    tutorial: {
      ...
      steps: {
        ...
        9: { title: '横扫相邻敌人。', body: '先锋可以攻击相邻一格，并伤害该格内所有敌方单位。', hint: '选择先锋，点击横扫，再选择高亮敌人。', wrong: '请选择刚刚生产的先锋。' },
        10: { title: '进行远程射击。', body: '游侠可以沿横向、纵向或 45° 斜线直线射击，最远距离为三格。', hint: '选择游侠，点击射击，再选择高亮敌人。', wrong: '请选择高亮的游侠。' },
