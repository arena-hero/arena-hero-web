...
const resources = {
  ...
  zh: { translation: {
    ...
    game: {
      ...
      resourceActivity: '资源变动', cargoDropped: 'Worker 掉落了 {{count}} 点资源', cargoRecovered: '回收了 {{count}} 点掉落资源', resourceOverflowDestroyed: '销毁了 {{count}} 点超额 Core 资源', depositCoreMoving: '交付失败：Core 在本 Tick 开始迁移。', depositCoreNotPresent: '交付失败：Worker 已经不在你的 Core 所在格。', depositWorkerEmpty: '交付失败：Worker 没有携带资源。', moreResourceEvents: '还有 {{count}} 条资源事件',
