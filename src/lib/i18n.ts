  ...
  en: { translation: {
    ...
    tutorial: {
      ...
      steps: {
        ...
        4: { title: 'Harvest the resource.', body: 'The Worker has reached the resource deposit and can collect one resource.', hint: 'Select the Worker and choose Harvest.', wrong: 'Select the Worker on the resource cell.' },
  ...
  zh: { translation: {
    ...
    tutorial: {
      ...
      steps: {
        ...
        4: { title: '采集资源。', body: '工人已经到达资源点，现在可以采集 1 点资源。', hint: '选择工人，然后点击采集。', wrong: '请选择资源格上的工人。' },
