...
const resources = {
  en: { translation: {
    ...
    game: {
      ...
      produceUnit: 'Produce unit', resourcesAvailable: '{{count}} available', unitCost: '{{cost}} resources', coreResourceFull: 'Resource storage is full. Capacity is population × 5 (currently {{capacity}}).',
  ...
  zh: { translation: {
    ...
    game: {
      ...
      resourceActivity: '资源变动', cargoDropped: 'Worker 掉落了 {{count}} 点资源', cargoRecovered: '回收了 {{count}} 点掉落资源', resourceOverflowDestroyed: '销毁了 {{count}} 点超额 Core 资源', moreResourceEvents: '还有 {{count}} 条资源事件',
      ...
      produceUnit: '生产单位', resourcesAvailable: '当前资源 {{count}}', unitCost: '{{cost}} 资源', coreResourceFull: '资源已达上限。上限为人口 × 5（当前 {{capacity}}）。',
