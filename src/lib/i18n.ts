  ...
  en: { translation: {
    ...
    tutorial: {
      ...
      steps: {
        ...
        10: { title: 'Shoot from range.', body: 'Rangers fire along a clear horizontal or vertical line up to three cells away.', hint: 'Select the Ranger, choose Shoot, then select the highlighted enemy.', wrong: 'Select the highlighted Ranger.' },
  ...
  zh: { translation: {
    ...
    tutorial: {
      ...
      steps: {
        ...
        10: { title: '进行远程射击。', body: '游侠可以沿无遮挡的横向或纵向射击，最远距离为三格。', hint: '选择游侠，点击射击，再选择高亮敌人。', wrong: '请选择高亮的游侠。' },
