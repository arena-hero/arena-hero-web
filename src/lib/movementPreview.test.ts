...
const state = (selected: WorldObject): PlayerState => ({ resources: 0, population: 1, population_tier: 0, upkeep_next_tick: 0, events: [], objects: [selected, { kind: 'OBSTACLE', positions: [[0, -1]] }, { kind: 'RESOURCE', positions: [[1, 0]], amount: 2, capacity: 10 }, { kind: 'UNIT', id: 'enemy', controlled: false, position: [-1, 0], hp: 2, unit_type: 'RANGER' }] })
